...
public class RegistroAlimentoActivity extends AppCompatActivity {
    ...
    private void registrarMascota() {
            ...
            if (idCombo!=0){
                ...
                String idDuenio=personasList.get(idCombo-1).getId();
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.btnAceptar: registrarMascota();
        }
    }

    public void onClick2(View view) {
        Intent miIntent = null;
        miIntent=new Intent(RegistroAlimentoActivity.this,MainActivity.class);
